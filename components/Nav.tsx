...
const Nav = () => {
  return (
    <nav className="flex bg-dark-blue px-10 text-white py-4 lg:px-20 lg:py-5 justify-between items-center">
      <section className="flex justify-between items-center gap-4">
        ...
        />
        <h1 className="font-light text-[1rem] lg:font-normal lg:text-[1.25rem]">
          GPRG
        </h1>
      </section>
      <ul className="flex justify-between gap-4 lg:gap-6 text-[0.75rem] lg:text-[1rem]">
        <li>
